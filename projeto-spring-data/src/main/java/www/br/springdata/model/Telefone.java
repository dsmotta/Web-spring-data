package www.br.springdata.model;
...
public class Telefone {
	...
	@Column(nullable = false) // não pode ser nulo -  é o brigatório
	private String numero;
	
	@ManyToOne(optional = false) // relacionamento muitos telefones para uma pessoa - opcional sendo false tem que ser informado o numero
